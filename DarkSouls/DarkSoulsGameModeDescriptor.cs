	...
	public class DarkSoulsGameModeDescriptor : GameModeDescriptorBase
	{
		...
		public override string CriticalFilesErrorMessage
		{
			get
			{
				...
				return ("DSfix by Durante is required for Dark Souls modding, make sure it's properly installed and up to date." + Environment.NewLine + "Link: https://www.nexusmods.com/darksouls/mods/19/" + Environment.NewLine + "Install it, then restart NMM.");
			}
		}
