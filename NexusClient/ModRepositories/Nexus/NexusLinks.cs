namespace Nexus.Client.ModRepositories.Nexus
{
	public static class NexusLinks
	{
		...
		public static string Issues
		{
			get
			{
				return @"https://github.com/Nexus-Mods/Nexus-Mod-Manager-Legacy/issues";
			}
		}
		...
		public static string UpdaterLegacy
		{
			get
			{
				return @"https://dev.nexusmods.com/client/";
			}
		}

		public static string Updater4dot5
		{
			get
			{
				return @"https://dev.nexusmods.com/client/4.5/";
			}
		}

		public static string Releases4dot5
		{
			get
			{
		...
		public static string ReleasesLegacy
		{
			get
			{
				return @"https://github.com/Nexus-Mods/Nexus-Mod-Manager-Legacy/releases";
			}
		}
